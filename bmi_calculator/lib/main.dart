...
class _HomeState extends State<Home> {
  ...
  String _infoText = "Inform your info!";

  void _resetFields() {
    weightController.text = "";
    heightController.text = "";
    setState(() {
      _infoText = "Inform your info!";
  ...
  void _calculate() {
    setState(() {
      ...
      if (bmi < 18.6) {
        _infoText = "Lower of weight (${bmi.toStringAsPrecision(3)})";
      } else if(bmi >= 18.6 && bmi < 24.9){
        _infoText = "Ideal weight (${bmi.toStringAsPrecision(4)})";
      } else if(bmi >= 24.9 && bmi < 29.9){
        _infoText = "A little above the weight (${bmi.toStringAsPrecision(4)})";
